...
try:
    ...
    print("""\033[35m
Сделано Ахъмыдом,гарантия.  давай номер гада
...
■■■■■■■■■■■■■■■■■■
""")
    phone = input("\033[35mНомер мразоты тупой +")
_phone = phone
os.system("clear")
block = """
...
так,взрывай ему жопу,жми enter        
"""
print("номер мразоты тупой:")
print(phone)
print(block)
input()
os.system("clear")
...
print("Номер мразоты тупой:")
print(phone)
print ('инициализация и подключение прошло успешно!идёт флуд атака...')
print ("""
...
■                  ■ 
■■■■■■■■■■■■
атака идёт на номер, будут также идти попытки атаки на привязанную почту""")
